...
const LoginScreen = (props: any) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Input placeholder="Password" secureTextEntry onChangeText={(text) => {
              console.log(text);
              setPassword(text);
            }}/>
            <SignupButton title="Login" onPress={() => {
              console.log('username', username);
              console.log('password', password);

              signin(props, username as string, password as string).then((res: any) => {

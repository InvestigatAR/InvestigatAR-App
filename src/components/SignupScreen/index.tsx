...
import {Button, View, Text, StyleSheet, Alert, AsyncStorage,} from 'react-native'
            ...
            <SignupButton
                ...
                onPress={() => {
                    ...
                    if (username && name && email && password) {
                        signup(props, username as string, name as string, email as string, password as string)
                        .then((res: any) => {
